...
job(JOB_NAME) {
    ...
    steps {
        shell("""
          make
          docker build -t 668139184987.dkr.ecr.us-east-1.amazonaws.com/TEMP-FOR-TESTING-ks-db-memsql-76-cluster-in-a-box-base -f Dockerfile-ciab . && echo "Successfully built base image"
          docker push 668139184987.dkr.ecr.us-east-1.amazonaws.com/TEMP-FOR-TESTING-ks-db-memsql-76-cluster-in-a-box-base && echo "Successfully pushed image"
      """)
    }
